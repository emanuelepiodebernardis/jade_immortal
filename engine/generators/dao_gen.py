...
DAOS = [
    ...
    ("lancia", "Dao della Lancia", "narrative", "La via che colpisce a distanza, diritta e fiera."),
    ("sciabola", "Dao della Sciabola", "narrative", "La via dei fendenti ampli e feroci."),
    ("arco", "Dao dell'Arco", "narrative", "La via che colpisce prima ancora dell'avvicinarsi."),
    ("pugno", "Dao del Pugno", "narrative", "La via del corpo come arma, senza intermediari."),
    ("bastone", "Dao del Bastone", "narrative", "La via della difesa instancabile e del contrattacco."),
